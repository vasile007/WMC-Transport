...
import SideNavAdmin from '../components/SideNavAdmin.jsx';
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#0B0D10] via-[#11151B] to-[#141820] text-[#F5F3EE] overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -top-28 -left-24 h-72 w-72 bg-[#D4AF37]/28 blur-3xl" />
        <div className="absolute top-12 right-0 h-64 w-64 bg-[#B98B2D]/24 blur-3xl" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-72 w-72 bg-[#D4AF37]/14 blur-3xl" />
      ...
      <header className="h-16 bg-[#11151B]/85 backdrop-blur border-b border-white/10 shadow-[0_14px_32px_rgba(0,0,0,0.45)] flex items-center justify-between px-6 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-[#B9B3A8]">Admin</span>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-sm text-[#E3DED5]">Hello, <b>{user?.name || 'Admin'}</b></span>
